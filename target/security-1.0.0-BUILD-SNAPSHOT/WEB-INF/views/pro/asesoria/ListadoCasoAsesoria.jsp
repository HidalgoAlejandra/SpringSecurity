...
<title>Listado Caso Asesoria Asesoria</title>
</head>
<body>
	<div class="banner"></div>
	

	<h1 class="text-center">Listado Caso Asesoría</h1>
	...
	<div class="wrapper">
		<table class="text-center table table-bordered" id="grid">
			...
			<c:forEach items="${listadoasesoria}" var="ase">
				<tr>
					...
					<td class="text-center">
						<a href="AceptarCaso?id_asesoria=${ase.getId_asesoria()}" class="btn btn-success" >Aceptar</a>
						&nbsp;
						<a href="RechazarCaso?id_asesoria=${ase.getId_asesoria()}" class="btn btn-danger">Rechazar</a>
					</td>
				</tr>
			</c:forEach>
